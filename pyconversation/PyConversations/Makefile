...
mo:
	...
	msgfmt -c -o data/locales/ru/LC_MESSAGES/PyConversations.mo data/locales/po/ru.po
	msgfmt -c -o data/locales/en/LC_MESSAGES/PyConversations.mo data/locales/po/en.po
